...
/**
 * Holds the address and channel-level options for a gRPC peer. In Phase 0
 * this is a plain configuration carrier — actual HTTP/2 connections are
 * established lazily inside each Call object.
 */
class Channel
{
    ...
    {
        // Pure-PHP implementation has no persistent connection to tear down;
        // each Call manages its own libcurl handle.
    }
}
