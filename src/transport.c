 ...
 * lifecycle, socket/TLS I/O, nghttp2 callbacks, and response frame parsing.
 * Request/response metadata conversion lives in narrower metadata helpers.
 * PHP entrypoints and module registration stay outside this file.
 */
