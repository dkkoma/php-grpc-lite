...
function usage(string $message): never
{
    ...
    fwrite(STDERR, "Usage: php tools/phase2/otelop-summary.php --run-id=<BENCH_OTEL_RUN_ID> [--suite=spanner-dml-unary-shape] [--endpoint=http://otelop:4319/graphql] [--limit=100000]\n");
    exit(2);
}
