...
docker compose run --rm --no-deps dev sh -lc '
    ...
    production_sources="grpc.c src/protocol_core.c src/response_header_phase.c src/status_core.c src/transport_core.c src/tls_config.c src/surface.c src/transport.c src/unary_call.c src/server_streaming_call.c src/wrapper_adapter.c"
