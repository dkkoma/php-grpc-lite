...
- Evidence: `docs/opentelemetry-instrumentation.md`
...
- Fix summary: `docs/opentelemetry-instrumentation.md`のJSON/TSV境界表現を削除し、現行のPHP runner外側wall-clock境界をOTEL span durationとして記録する説明にした。
- Fix commit: `8819d2e`
