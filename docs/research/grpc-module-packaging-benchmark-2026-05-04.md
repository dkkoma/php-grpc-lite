...
docker compose run --rm dev php -d extension=/workspace/ext/grpc/modules/grpc.so -r 'var_export([extension_loaded("grpc"), extension_loaded("nghttp2_poc"), function_exists("nghttp2_poc_persistent_channel_unary")]); echo PHP_EOL;'
