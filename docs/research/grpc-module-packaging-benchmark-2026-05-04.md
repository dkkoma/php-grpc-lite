...
docker compose run --rm dev php -d extension=/workspace/ext/grpc/modules/grpc.so -r 'var_export([extension_loaded("grpc"), function_exists("grpc_lite_unary")]); echo PHP_EOL;'
