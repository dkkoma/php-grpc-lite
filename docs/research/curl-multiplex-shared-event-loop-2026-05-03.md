...
- `tools/benchmark/curl-multiplex-streaming.php`
- `bench/compare-curl-multiplex-event-loop.sh`
...
```bash
BENCH_TAG=20260503-curl-multiplex-event-loop bench/compare-curl-multiplex-event-loop.sh
```
