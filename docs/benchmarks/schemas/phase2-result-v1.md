...
| `suite` | runner suite 名。例: `contract-smoke`, `cpu-memory-smoke`, `throughput-unary`, `rtt-unary`, `large-streaming`, `payload-unary-diagnostic`, `payload-breakdown`, `metadata-header` |
