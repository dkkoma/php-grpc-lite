# Benchmark decision comparison 2026-04-29

Phase 2 の最適化判断に使う長めの比較 run。`bench/preset.sh decision` で取得した。
...
```bash
BENCH_TAG=phase2-server-timing-20260429 ./bench/run.sh payload-unary-diagnostic --duration=3 --payload-sizes=102400 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-server-cached-20260429 ./bench/run.sh payload-unary-diagnostic --duration=3 --payload-sizes=102400 --warmup-calls=10
BENCH_TAG=phase2-server-cached-20260429 ./bench/run.sh payload-unary-diagnostic-cached --duration=3 --payload-sizes=102400 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-transfer-breakdown-20260429 ./bench/run.sh payload-unary-diagnostic --duration=3 --payload-sizes=102400 --warmup-calls=10
BENCH_TAG=phase2-transfer-breakdown-20260429 ./bench/run.sh payload-unary-diagnostic-cached --duration=3 --payload-sizes=102400 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-server-stats-20260429 ./bench/run.sh payload-unary-diagnostic --duration=3 --payload-sizes=102400 --warmup-calls=10
BENCH_TAG=phase2-server-stats-20260429 ./bench/run.sh payload-unary-diagnostic-cached --duration=3 --payload-sizes=102400 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-curl-trace-smoke-20260429 ./bench/run.sh payload-unary-diagnostic-cached --duration=0.2 --payload-sizes=102400 --warmup-calls=3 --curl-trace-output=var/bench-results/phase2-curl-trace-smoke-20260429.log --curl-trace-calls=2
```
...
```bash
BENCH_TAG=phase2-client-breakdown-20260429 ./bench/run.sh payload-unary-diagnostic-cached --duration=5 --max-calls=1000 --payload-sizes=0,100,1024,10240,102400,1048576 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-ext-client-boundary-20260429 BENCH_IMPLEMENTATION=php-grpc-lite ./bench/run.sh payload-unary-diagnostic-cached --duration=5 --max-calls=1000 --payload-sizes=1048576 --warmup-calls=10
BENCH_TAG=phase2-ext-client-boundary-20260429 BENCH_IMPLEMENTATION=ext-grpc ./bench/run.sh payload-unary-diagnostic-cached --duration=5 --max-calls=1000 --payload-sizes=1048576 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-chunk-list-20260429 BENCH_IMPLEMENTATION=php-grpc-lite ./bench/run.sh payload-unary-diagnostic-cached --duration=5 --max-calls=2000 --payload-sizes=102400,1048576 --warmup-calls=10
BENCH_TAG=phase2-chunk-list-1mb-1000-20260429 BENCH_IMPLEMENTATION=php-grpc-lite ./bench/run.sh payload-unary-diagnostic-cached --duration=5 --max-calls=1000 --payload-sizes=1048576 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-stream-buffer-20260429 ./bench/run.sh throughput-streaming --duration=2 --message-count=1000 --payload-bytes=100 --warmup-streams=2
```
...
```bash
BENCH_TAG=phase2-large-request-20260429 BENCH_IMPLEMENTATION=php-grpc-lite ./bench/run.sh request-unary-diagnostic --duration=5 --max-calls=1000 --request-payload-sizes=102400,1048576 --warmup-calls=10
BENCH_TAG=phase2-large-request-20260429 BENCH_IMPLEMENTATION=ext-grpc ./bench/run.sh request-unary-diagnostic --duration=5 --max-calls=1000 --request-payload-sizes=102400,1048576 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-upload-callback-20260429 BENCH_IMPLEMENTATION=php-grpc-lite ./bench/run.sh request-unary-diagnostic --duration=5 --max-calls=1000 --request-payload-sizes=102400,1048576 --warmup-calls=10
BENCH_TAG=phase2-upload-callback-repeat-20260429 BENCH_IMPLEMENTATION=php-grpc-lite ./bench/run.sh request-unary-diagnostic --duration=5 --max-calls=1000 --request-payload-sizes=1048576 --warmup-calls=10
```
...
```bash
BENCH_TAG=phase2-rtt-diagnostic-20260429 ./bench/run.sh rtt-unary-diagnostic --calls=10 --warmup-calls=2
```
...
```bash
BENCH_TAG=phase2-metadata-diagnostic-20260429 ./bench/run.sh metadata-header-diagnostic --calls=100
```
